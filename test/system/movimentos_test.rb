...
class MovimentosTest < ApplicationSystemTestCase
  ...
  test "creating a Movimento" do
    ...
    fill_in "Conta movimento tipo", with: @movimento.conta_movimento_tipo
    fill_in "Contum", with: @movimento.contum_id
    fill_in "Valor movimento", with: @movimento.valor_movimento
